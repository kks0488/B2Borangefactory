...
export const metadata: Metadata = {
  title: 'Wholesale Sourcing | Orange Factory',
  description: 'Access premium Korean fashion brands at competitive wholesale prices. Direct from Korea.',
};

export default function WholesalePage() {
  const features = [
    { icon: <Package className="w-6 h-6" />, title: "Premium Brands", desc: "Access to 1,200+ Korean fashion brands including streetwear, casual, and luxury segments." },
    { icon: <TrendingUp className="w-6 h-6" />, title: "Competitive Pricing", desc: "Direct sourcing means better margins. Up to 70% below retail on quality Korean fashion." },
    { icon: <ShieldCheck className="w-6 h-6" />, title: "Quality Guaranteed", desc: "100% authentic products with quality inspection before shipping. No counterfeits, ever." }
  ];

  const steps = [
    { num: "1", title: "Submit Inquiry", desc: "Tell us what you're looking for" },
    { num: "2", title: "Receive Quote", desc: "Get pricing and product catalog" },
    { num: "3", title: "Place Order", desc: "Confirm order and shipping details" },
  ];

  const faqs = [
    { q: "What is the minimum order quantity?", a: "MOQ varies by brand and product type. We work with orders from $5,000 USD and up." },
    { q: "Do you offer samples?", a: "Yes, we can arrange samples for serious buyers. Sample costs are deducted from bulk orders." },
  ];
      ...
      <section className="pt-32 pb-16 md:pt-40 md:pb-24">
        <div className="section-container">
          <div className="flex items-center gap-3 mb-6">
            ...
            <span className="text-sm font-bold tracking-widest text-[#FF8C00]">WHOLESALE</span>
          </div>
          ...
          <p className="text-lg text-slate-600 max-w-2xl leading-relaxed">
            Source premium Korean fashion brands directly. 40 years of industry connections 
            give you access to the best K-Fashion at wholesale prices.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 md:py-16 border-t border-slate-200">
        <div className="section-container text-center">
          ...
          <Button className="bg-[#FF8C00] hover:bg-[#E67E00] text-white h-12 px-8 rounded-lg font-semibold" asChild>
            <Link href="/en/contact" className="flex items-center gap-2">Request Quote <ArrowRight className="w-4 h-4" /></Link>
          </Button>
        </div>
      </section>
    </div>
