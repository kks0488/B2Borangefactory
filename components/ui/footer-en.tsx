      ...
      <div className="section-container py-10">
        <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-8">
          ...
          <div className="flex-shrink-0">
            <Link href="/en" className="inline-block mb-3">
              <Image 
                src="/img/logo.png" 
                alt="Orange Factory" 
                width={100} 
            ...
            <p className="text-sm text-slate-500">
              Korean Fashion Wholesale<br />Since 1985
            </p>
          </div>
          ...
          <div className="flex flex-wrap gap-x-12 gap-y-6">
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <Link href="/" className="flex items-center gap-1 text-sm text-slate-600 hover:text-[#FF8C00] transition-colors">
                    <Globe className="w-3.5 h-3.5" /> 한국어 사이트
                  </Link>
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="tel:+82-10-4464-0345" className="flex items-center gap-2 text-sm text-slate-600 hover:text-[#FF8C00] transition-colors">
        ...
        <div className="mt-10 pt-6 border-t border-slate-100 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
          <p className="text-xs text-slate-400">
            © {currentYear} Orange Factory. All rights reserved.
          </p>
          <p className="text-xs text-slate-400">
            40 Years of Korean Fashion Excellence
          </p>
        </div>
      </div>
    </footer>
