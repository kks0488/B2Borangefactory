                ...
                <div className="absolute right-0 top-full mt-1 bg-white border border-slate-200 rounded-lg shadow-lg py-1 min-w-[120px] z-50">
                  {languages.map((lang) => (
                    <Link
                      key={lang.href}
                      href={lang.href}
                      className="flex items-center gap-2 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 hover:text-[#FF8C00]"
          ...
          <div className="px-4 py-3">
            ...
            <div className="mt-3 pt-3 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-1">
                {languages.map((lang) => (
                  <Link key={lang.href} href={lang.href} className="flex items-center gap-2 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg" onClick={() => setIsMobileMenuOpen(false)}>
