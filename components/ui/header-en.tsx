          ...
          <div className="px-4 py-3">
            ...
            <div className="mt-3 pt-3 border-t border-slate-100">
              ...
              <div className="grid grid-cols-2 gap-1">
                {LANGUAGES.map((lang) => (
                  <Link key={lang.href} href={lang.href} className="flex items-center gap-2 px-3 py-2 text-sm text-slate-700 hover:bg-slate-50 rounded-lg" onClick={handleMenuClose}>
